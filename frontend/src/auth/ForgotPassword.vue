          ...
          <div class="w-1/2">
            <FormField v-slot="{ componentField }" :form="form" name="email">
              <FormItem>
                ...
                <FormControl>
                  <Input class="dark:border-mintGreen" type="text" placeholder="johndoe" v-bind="componentField" />
                </FormControl>
                <FormMessage />
              </FormItem>
            </FormField>
            ...
            <div class="pt-8">
              <Button type="submit" class="w-full dark:text-black bg-accentPrimary dark:bg-mintGreen">
                <span>Envoyer la demande</span>
              </Button>
            </div>

            <div v-if="submitSuccess" class="mt-4 text-green-600">
              Un email de réinitialisation a été envoyé à votre adresse. Veuillez vérifier votre boîte de réception (et vos spams !).
            </div>
